            ...
            res.on('end', () => {
                ...
                if (last != parsedjson[0].id.toString()) {
                    // console.log('new post! ' + last + ' to ' + parsedjson[0].id.toString());
                     //client.guilds.findAll('name', '/!')[0].channels.findAll('name', 'nsfw')[0].sendMessage('Nitro faved something on e621 ( ͡° ͜ʖ ͡°).');
                     //client.guilds.findAll('name', '/!')[0].channels.findAll('name', 'nsfw')[0].sendMessage('systemctl e621 1 favoritedby:furrylocked');
            ...
            res.on('end', () => {
                ...
                if (last != parsedjson[0].id.toString()) {
                    ...
                    if (parsedjson[0].rating == 's') {
                     ...
                     //client.guilds.findAll('name', '/!')[0].channels.findAll('name', 'nsfw')[0].sendMessage('hitius faved something on ' + e926);
                     //client.guilds.findAll('name', '/!')[0].channels.findAll('name', 'nsfw')[0].sendMessage('systemctl e621 1 favoritedby:hitius');
